                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    gradient: LinearGradient(
                                      ...
                                      colors: [
                                        const Color(0xFF4B7BE5).withOpacity(0.1),
                                        const Color(0xFF4B7BE5).withOpacity(0.05),
                                      ],
                                    ),
                                    borderRadius: BorderRadius.circular(16),
                                    border: Border.all(
                                    ...
                                    Expanded(
                                      child: TextButton(
                                        ...
                                        style: TextButton.styleFrom(
                                          backgroundColor: const Color(0xFF4B7BE5).withOpacity(0.1),
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: const CircularProgressIndicator(
                                          strokeWidth: 3,
                                          valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF4B7BE5)),
                                        ),
                                      ),
                                      const SizedBox(height: 24),
                                      ShaderMask(
